      ...
      <section className='mx-7'>
        <div class="grid   sm:grid-cols-2 md:grid-cols-3 gap-4 mb-7">
          {products.map(product => (
            <div key={product.id} className="bg-white text-center border-b-4 border-white hover:border-blue-600">
              <img src={product.image} alt={product.name} className="mx-auto h-auto object-contain" />
